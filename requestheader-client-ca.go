...
func extractRequestheaderInfo(kc kubernetes.Interface, info *ClusterInfo) error {
	authConfigMap, err := kc.CoreV1().ConfigMaps(authenticationConfigMapNamespace).Get(authenticationConfigMapName, metav1.GetOptions{})
	if err != nil {
		return err
	}
